...
% query 2
?- phone(X).
?- phone(X), age(X, Y), Y > 30.
?- phone(X), brand_preference(X, Y), Y = samsung.
?- phone(X), brand_preference(X, Y), Y = huawei.
?- phone(X), brand_preference(X, Y), Y = oppo.
?- phone(X), brand_preference(X, Y), Y = oneplus.
?- phone(X), brand_preference(X, Y), Y = nokia.
?- phone(X), brand_preference(X, Y), Y = samsung, age(X, Z), Z > 30.
?- phone(X), brand_preference(X, Y), Y = huawei, age(X, Z), Z > 30.
?- phone(X), brand_preference(X, Y), Y = oppo, age(X, Z), Z > 30.
?- phone(X), brand_preference(X, Y), Y = oneplus, age(X, Z), Z > 30.
?- phone(X), brand_preference(X, Y), Y = nokia, age(X, Z), Z > 30.
?- phone(X), brand_preference(X, Y), Y = samsung, income(X, Z), Z > 20000.
?- phone(X), brand_preference(X, Y), Y = huawei, income(X, Z), Z > 20000.
?- phone(X), brand_preference(X, Y), Y = oppo, income(X, Z), Z > 20000.
?- phone(X), brand_preference(X, Y), Y = oneplus, income(X, Z), Z > 20000.
?- phone(X), brand_preference(X, Y), Y = nokia, income(X, Z), Z > 20000.
...
% % 1). What are the brands of phones that a person uses?

% ?- uses_phone(X, Y).
% X = jessica, Y = iphone_6;
% X = jessica, Y = iphone_6_plus;
% X = jessica, Y = iphone_7;
% X = jessica, Y = iphone_7_plus;
% X = jessica, Y = iphone_8;
% X = jessica, Y = iphone_8_plus;
% X = jessica, Y = iphone_X;
% X = jessica, Y = iphone_XS;
% X = jessica, Y = iphone_X;
